 ...
 <table class="order_info">
        ...
        <tbody>
           ...
           <c:forEach items="${infoList }" var="info" varStatus="status">
            ...
            <tr>                           
                <td rowspan="${cnt}"  class="onum_th"><a href="${pageContext.request.contextPath }/order/orderReadForm?onum=${info.onum}"
                										 style="border-bottom: 1px solid gray;"> [${info.onum }]</a></td>
                </c:if>
